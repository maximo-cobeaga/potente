    ...
    return (
        <>
            <div className="contacto">
                ...
                <a target='_blank' className='button-link' href={`https://api.whatsapp.com/send?phone=2235851198&text=%C2%A1Hola!%20quiero%20informacion%20sobre%20la%20propiedad%3A%20${titulo_propiedad !== undefined && titulo_propiedad.replaceAll(' ', '%20')}.%20(Id%3A%20${id !== undefined && id})`}>
            ...
            <FormularioContacto oficina={'Oficina: Av. de los Trabajadores 2439'} />
